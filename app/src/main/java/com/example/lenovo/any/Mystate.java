...
public class Mystate extends AppCompatActivity {
    ...
    public void setUpRecyclerView() {
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final DocumentSnapshot documentSnapshot, int position) {
                ...
                String classname=Mystate.class.getSimpleName();
                ...
                Intent intent=new Intent(Mystate.this, AnswerActivity.class);
    ...
    protected void onStart() {
        ...
        notebookRef = db.collection(userstate+" mystate");
...
public void go_to_home(View view){
    ...
    public void go_to_movies(View view){
