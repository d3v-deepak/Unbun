...
public class Buisness extends AppCompatActivity {
    ...
    public void setUpRecyclerView() {
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final DocumentSnapshot documentSnapshot, int position) {
                ...
                String usernaam=note.getUsername();//email
                String classname=Buisness.class.getSimpleName();
                //int repcount=note.getReport_count();
                //      Intent intent2 = getIntent();
                //   answer2 = ;
                //     answer2=null;
                //  DocumentReference documentReference=documentSnapshot.getReference();
                //documentReference.update("answer",intent2.getStringExtra("newans"));
                Intent intent=new Intent(Buisness.this, AnswerActivity.class);
    ...
    protected void onStart() {
        ...
        notebookRef = db.collection(userstate+" buisness");
...
startActivity(intent);
    ...
    public void go_to_politics(View view){
