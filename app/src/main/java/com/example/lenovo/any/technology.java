...
public class technology extends AppCompatActivity {
    ...
    public void setUpRecyclerView() {
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final DocumentSnapshot documentSnapshot, int position) {
                ...
                String classname=technology.class.getSimpleName();
             ...
             Intent intent=new Intent(technology.this, AnswerActivity.class);
    ...
    protected void onStart() {
        ...
        notebookRef = db.collection(userstate+" technology");
